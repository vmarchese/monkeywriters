...
module.exports =  function(app,mongo,config,swagger){
  ...
  var info = {
    'spec': {
      ...
      "path" : "/monkeys/{monkeyid}/followers",
      "notes" : "Returns a List of Followers of Monkey",
      "summary" : "Find Monkey's Followers ",
      "method": "GET",
      "parameters" : [swagger.pathParam("monkeyid", "username of the followed monkey", "string")],
      "type" : "Monkey",
      "produces" : ["application/json"],
      "errorResponses" : [swagger.errors.invalid('monkeyid'), swagger.errors.notFound('monkey')],
      "nickname" : "getMonkeyFollowers"/*,
     "authorizations": {
            "oauth2": [
              {
                "scope": "test:anything",
